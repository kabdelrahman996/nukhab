...
export default function Hero() {
  return (
    ...
    >
      ...
      {/* Soft Glow Top */}
      <div className="absolute top-[-10%] right-[-5%] w-[320px] md:w-[500px] h-[320px] md:h-[500px] rounded-full bg-[#D4AF37]/10 blur-3xl" />

      {/* Soft Glow Bottom */}
      <div className="absolute bottom-[-10%] left-[-10%] w-[350px] md:w-[600px] h-[350px] md:h-[600px] rounded-full bg-blue-500/10 blur-3xl" />

      {/* Grid */}
      <div className="hero-grid absolute inset-0 opacity-[0.04]" />

      {/* Noise */}
      <div className="absolute inset-0 opacity-[0.02] bg-[url('/noise.png')] mix-blend-soft-light pointer-events-none" />
