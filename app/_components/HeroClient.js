...
export default function HeroClient() {
  return (
    <section
      dir="rtl"
      className="relative min-h-screen overflow-hidden bg-[#040816] text-white flex items-center before:absolute before:inset-0 before:bg-[radial-gradient(circle_at_top,rgba(212,175,55,0.08),transparent_40%)]"
    >
      {/* Background */}
      <div className="absolute inset-0 bg-[#040816]" />

      {/* Glow blobs */}
      <div className="absolute top-[-10%] right-[-5%] w-[320px] h-[320px] rounded-full bg-[#D4AF37]/10 blur-3xl animate-scale-in" />

      <div className="absolute bottom-[-10%] left-[-10%] w-[350px] h-[350px] rounded-full bg-blue-500/10 blur-3xl animate-glow" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-28 pb-16 md:pt-36 md:pb-24 w-full">
        <div className="grid lg:grid-cols-2 gap-16 items-center">
          ...
          <div className="text-center lg:text-right flex flex-col items-center lg:items-start">
            {/* Badge */}
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full mb-6 border border-white/10 bg-white/[0.03] backdrop-blur-xl animate-fade-up delay-1">
            ...
            {/* Headline */}
            <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black leading-[1.1] tracking-tight animate-fade-left delay-2">
              واجهات ترفع
            ...
            {/* Paragraph */}
            <p className="mt-6 text-base md:text-xl text-slate-400 leading-relaxed max-w-2xl animate-fade-up delay-3">
              نصمم صفحات هبوط وتجارب رقمية فاخرة تجمع بين الإقناع، السرعة،
              والانبهار البصري لتحويل جمهورك إلى عملاء.
            </p>

            {/* CTA */}
            <div className="flex flex-col sm:flex-row gap-4 mt-8 w-full sm:w-auto animate-fade-up delay-4">
              <button className="relative overflow-hidden px-8 py-4 rounded-2xl bg-gradient-to-r from-[#D4AF37] to-[#F5D76E] text-black font-extrabold shadow-[0_0_30px_rgba(212,175,55,0.25)] transition-all duration-500 hover:scale-[1.03] hover:shadow-[0_0_45px_rgba(212,175,55,0.45)] animate-shimmer">
                <Link
                  href="#cta"
              ...
              <button className="px-8 py-4 rounded-2xl border border-white/10 bg-white/[0.03] backdrop-blur-xl hover:bg-white/[0.05] hover:border-white/20 transition-all duration-300 hover:scale-[1.02]">
                شاهد الأعمال
              </button>
            </div>

            {/* Features */}
            <div className="flex flex-wrap gap-6 mt-8 text-slate-400 text-sm animate-fade-up delay-4">
          ...
          {/* VISUAL */}
          <div className="relative flex items-center justify-center animate-fade-up delay-3">
            {/* Glow */}
            <div className="absolute w-[320px] h-[320px] rounded-full bg-[#D4AF37]/10 blur-3xl animate-pulse" />

            {/* Phone */}
            <div className="relative w-[290px] h-[600px] rounded-[3rem] border border-white/10 bg-gradient-to-b from-white/[0.06] to-white/[0.02] overflow-hidden shadow-2xl animate-scale-in delay-3 hover:scale-[1.02] transition-transform duration-500 backdrop-blur-2xl">
              {/* top glow */}
              ...
              <div className="relative h-full p-6 pt-20 flex flex-col">
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="px-3 py-1 rounded-xl bg-emerald-500/20 text-emerald-400 text-sm border border-emerald-500/20">
                    +24%
                  </div>
                </div>

                {/* Chart */}
                <div className="mt-10 h-48 rounded-3xl border border-white/10 bg-gradient-to-br from-cyan-500/10 to-transparent p-5 flex items-end gap-3 justify-center backdrop-blur-xl">
                  {[80, 110, 70, 150, 180].map((h, i) => (
                    <div
                      ...
                      className={`w-5 rounded-full animate-bar ${
                ...
                <div className="grid grid-cols-2 gap-4 mt-6">
                  <div className="rounded-2xl border border-white/10 bg-black/20 p-4 backdrop-blur-xl hover:border-white/20 transition-all duration-300">
                ...
                <div className="mt-auto space-y-4">
                  <div className="h-3 rounded-full bg-white/10 overflow-hidden">
                    <div className="h-full w-[82%] animate-progress bg-gradient-to-r from-cyan-400 to-blue-500 rounded-full" />
                  </div>

                  <div className="h-3 rounded-full bg-white/10 overflow-hidden">
                    <div className="h-full w-[65%] animate-progress bg-gradient-to-r from-[#D4AF37] to-yellow-300 rounded-full [animation-delay:.3s]" />
                  </div>
                </div>
              </div>
